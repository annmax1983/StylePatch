...
- `host_permissions`: Only used to inject custom CSS styles to adjust page background, text color and font size. Does not read DOM text, images, form data or cookies.
